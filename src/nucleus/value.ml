...
let as_option ~loc = function
  ...
  | (Term _ | Closure _ | Handler _ | Tag _ | List _ | Tuple _ | Ref _
    | String _ | Numeral _ | Ident _) as v ->
...
and print_value ~penv ?max_level refs v ppf =
  ...
  | Numeral n -> Print.print ?max_level ~at_level:0 ppf "%d" n
...
let rec equal_value v1 v2 =
  match v1, v2 with
    ...
    | Ident x1, Ident x2 -> Name.eq_ident x1 x2
    ...
    | Term _, (Closure _ | Handler _ | Tag _ | List _ | Tuple _ | Ref _ | String _ | Numeral _ | Ident _)
    | Closure _, (Term _ | Handler _ | Tag _ | List _ | Tuple _ | Ref _ | String _ | Numeral _ | Ident _)
    | Handler _, (Term _ | Closure _ | Tag _ | List _ | Tuple _ | Ref _ | String _ | Numeral _ | Ident _)
    | Tag _, (Term _ | Closure _ | Handler _ | List _ | Tuple _ | Ref _ | String _ | Numeral _ | Ident _)
    | List _, (Term _ | Closure _ | Handler _ | Tag _ | Tuple _ | Ref _ | String _ | Numeral _ | Ident _)
    | Tuple _, (Term _ | Closure _ | Handler _ | Tag _ | List _ | Ref _ | String _ | Numeral _ | Ident _)
    | String _, (Term _ | Closure _ | Handler _ | Tag _ | List _ | Tuple _ | Ref _ | Numeral _ | Ident _)
    | Numeral _, (Term _ | Closure _ | Handler _ | Tag _ | List _ | Tuple _ | Ref _ | String _ | Ident _)
    | Ident _, (Term _ | Closure _ | Handler _ | Tag _ | List _ | Tuple _ | Ref _ | String _ | Numeral _)
    | Ref _, (Term _ | Closure _ | Handler _ | Tag _ | List _ | Tuple _ | String _ | Numeral _ | Ident _) ->
      false
